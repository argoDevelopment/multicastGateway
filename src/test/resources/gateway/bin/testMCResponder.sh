...
java -cp $GW_HOME/lib/@JAR_NAME@.jar -Djava.util.logging.config.file="$GW_HOME/bin/logging.properties" -Dnet.java.preferIPv4Stack=true ws.argo.mcg.ws.argo.mcg.comms.MCastMultihomeResponder "$@"
